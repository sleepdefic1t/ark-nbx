...
# Page look
use constant TITLE => 'ArkBox board';	# Name of this image board
...
use constant TITLEIMG => '/content/img/arkbox-logo-small.png';			# Title image (point to a script file if rotating)
