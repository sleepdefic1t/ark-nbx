...
generate_lighttpd_env $GLOBAL_CHAT "$GLOBAL_DEST" $ARKBOX_PYTHONPATH $GEN_CHATFILE $ARKBOX_FOLDER  $CHATFILE $SHOUTBOX_CLIENT_TIMESTAMP $UPLOADFOLDER $GEN_DISKFILE
